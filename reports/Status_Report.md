...
*   **Key Activities**:
    *   **Algorithm Design (40h)**: Researched and implemented the joint angle scoring algorithm. Developed confidence-aware weighting mechanism and angle difference calculation. Tuned weight parameters for optimal scoring.
